  ...
  //  private Date date_reservation;
   ...
   /* public Date getDate_reservation() {
    ...
    public String toString() {
        return "Reservation prix=" + prix + ", siege=" + siege + ", Qr=" + Qr + ", nb_place=" + nb_place + ", id_user=" + id_user + ", id_event=" + id_event + ", id=" + id + '}';
    }
    ...
    java.util.Date sqlDate = new java.util.Date(date1.getTime());
