...
class EvenementController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('evenement_show', array('idevent' => $evenement->getIdevent()));
        }
     ...
     *
     * @Route("/{idevent}", name="evenement_show")
     * @Method("GET")
     */
    ...
    public function editAction(Request $request, Evenement $evenement)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('evenement_edit', array('idevent' => $evenement->getIdevent()));
        }
     ...
     *
     * @Route("/{idevent}", name="evenement_delete")
     * @Method("DELETE")
     */
    ...
    private function createDeleteForm(Evenement $evenement)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('evenement_delete', array('idevent' => $evenement->getIdevent())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
