...
public class TextFieldValidation {
    ...
    {   boolean b =true;
        ...
        lb.setText(msg);
        return b;}
    public static boolean isTextFieldNotNumber(TextField tf)
    {   boolean b =false;
        if(tf.getText().matches("([0-9]+(\\\\.[0-9]+)?)+"))
            b=true;
        return b;
    }
    public static boolean isTextFieldNotNumber(TextField tf , Label lb , String errorMessage)
    {    boolean b =false;
        String msg=null;
        if(!isTextFieldNotNumber(tf)){
            b=true;
            msg=errorMessage;}
        lb.setText(msg);
        return b;
