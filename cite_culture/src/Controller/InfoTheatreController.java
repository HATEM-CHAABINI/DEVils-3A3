 ...
 * @author mouna dridi
 */
public class InfoTheatreController implements Initializable {
 private final TheatreService fs=new TheatreService();
    @FXML
...
//    Class CommandsController = getClass();
 ...
 public void addLabels(){
		...
		String s="abc";
		List<Theatre> maList=fs.tousTheatres();
                int p=0;
                int i=0;
...
//              tooltip1.setGraphic(k1.toString());
   ...
   plo.setOnAction(new EventHandler<ActionEvent>() {
      @Override public void handle(ActionEvent t) {
          try {
              ...
              loader.setLocation(getClass().getResource("/View/voirTheatre.fxml"));
              Parent root=loader.load();
              VoirTheatreController vfc=loader.getController();
              vfc.setTheatre(maList.get(kvalue));
              Scene scene = new Scene(root);
              Stage stage=new Stage();              
              stage.setScene(scene);
              stage.show();
          } catch (IOException ex) {
              Logger.getLogger(InfoTheatreController.class.getName()).log(Level.SEVERE, null, ex);
          }
        }
      });
 ...
 public void addLabelsWithList(List<Theatre> maList){
 ...
 @FXML
        public void affWhere(ActionEvent event){
            ...
            List<Theatre> maList=fs.tousTheatresParDate(java.sql.Date.valueOf(date.getValue()));
