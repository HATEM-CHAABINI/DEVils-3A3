 ...
 * @author mouna dridi
 */
public class InfoGalerieController implements Initializable {
    private final GalerieService fs=new GalerieService();
    @FXML
...
public void addLabels(){
		...
		String s="abc";
		List<Galerie> maList=fs.tousGaleries();
                int p=0;
                int i=0;
   ...
   plo.setOnAction(new EventHandler<ActionEvent>() {
      @Override public void handle(ActionEvent t) {
          try {
              ...
              loader.setLocation(getClass().getResource("/View/voirGalerie.fxml"));
              Parent root=loader.load();
              VoirGalerieController vfc=loader.getController();
              vfc.setGalerie(maList.get(kvalue));
              Scene scene = new Scene(root);
              Stage stage=new Stage();              
              stage.setScene(scene);
              stage.show();
          } catch (IOException ex) {
              Logger.getLogger(InfoGalerieController.class.getName()).log(Level.SEVERE, null, ex);
          }
        }
      });
...
public void addLabelsWithList(List<Galerie> maList){
...
@FXML
        public void affWhere(ActionEvent event){
            ...
            List<Galerie> maList=fs.tousGalerieParDate(java.sql.Date.valueOf(date.getValue()));
